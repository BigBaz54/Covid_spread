...
\subsubsection{Comparaison entre le taux de mortalité et le taux de propagation}
...
La corrélation entre les deux indicateurs est de 0.12, ce qui confirme que le taux de mortalité
n'est pas un bon indicateur de la propagation du virus.

\subsubsection{Corrélation entre la position et la propagation}

Nous avons essayé de réproduire les résultats de l'étude précédente \cite{kaggle} en comparant
la valeur absolue de latitude des pays avec leur taux de mortalité d'abord puis avec notre taux de propagation.
...
On obtient une corrélation assez faible de 0.20 et un graph (fig. \ref{fig:mort_lat})
...
aux sein des États-Unis pour affirmer que la latitude est un facteur important dans la
propagation du virus. Comme nous le voyons à l'échelle du monde, cette corrélation
est faible et il nous semble plus probable que d'autres facteurs entrent en jeu. Dans
...
plus faible de 0.10 et la distribution est encore plus uniforme. (fig. \ref{fig:spread_lat})
...
La corrélation avec la longitude valant 0.09 (fig. \ref{fig:spread_lon}), nous pouvons conclure que la position
